...
@section('content')
<h2 class="font-display text-2xl font-bold mb-6">Forgot Password</h2>
<p class="mb-6 text-sm" style="color: var(--ink-soft);">Enter your email to receive a password reset code.</p>
